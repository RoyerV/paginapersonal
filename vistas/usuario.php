...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input type="text" class="form-control" name="num_documento" id="num_documento" placeholder="N°" maxlength="12">
    </div>
       <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="telefono" id="telefono" maxlength="8" placeholder="Número de telefono">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="cargo" id="cargo" maxlength="12" placeholder="Cargo">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
